...
\begin{document}
    ...
    \begin{header}
        ...
        \textbf{Abdullah Al Amin}

        \vspace{0.3 cm}

        \normalsize
        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}Dayton, OH}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+90-541-999-99-99}{{\footnotesize\faPhone*}\hspace*{0.13cm} + 1 857 231 0198}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
