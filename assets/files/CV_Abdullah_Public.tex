...
\setlength{\parindent}{0 pt} % no indentation
\setlength{\columnsep}{0 pt} % set column seperation
\makeatletter
...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Last updated: \today}\hspace{\widthof{Last updated in September 2024}}
    }}}%
  }%
}%
...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.02 in}Dayton, OH}%
        \kern 0.002 in%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{mailto:aamin1@udayton.edu}{{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}aamin1@udayton.edu}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+1 857 231 0198}{{\footnotesize\faPhone*}\hspace*{0.13cm} + 1 857 231 0198}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://smalt.dev/}{{\footnotesize\faLink}\hspace*{0.13cm}smalt.dev}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/neoceph}{{\footnotesize\faLinkedinIn}\hspace*{0.13cm}neoceph}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://github.com/alamin-research}{{\footnotesize\faGithub}\hspace*{0.13cm}alamin-research}}%
    \end{header}
